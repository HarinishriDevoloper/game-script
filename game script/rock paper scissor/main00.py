...
# def resize_image(size=(500, 300)):
#     image = Image.open()
#     image = image.resize(size)
#     return ImageTk.PhotoImage(image)

rock_img = tk.PhotoImage("images/rock.png" ,(200,200))
paper_img = tk.PhotoImage("images/paper.png",(200,200))
scissors_img = tk.PhotoImage("images/scissors.png",(200,200))

play_button_img = tk.PhotoImage("images/button_lets-play-a-game.png", size=(150, 50))
start_button_img = tk.PhotoImage("images/button_start-game.png", size=(150, 50))
try_again_button_img = tk.PhotoImage("images/button_try-again.png", size=(150, 50))
cancel_button_img = tk.PhotoImage("images/button_cancel.png", size=(150, 50))
...
def show_result_window():
    ...
    if player_score > computer_score:
        ...
        result_image=tk.PhotoImage("images/congragulations.png",size=(500, 300))
       
    else:
        result_text = f"Sorry {player_name}, you lose. Better luck next time!"
        result_image=tk.PhotoImage("images/games.png",size=(500, 300))
...
welcome_img = tk.PhotoImage("images/imagess.png",size=(500, 300)) 
...
game_start_img = tk.PhotoImage("images/start image.png",size=(500, 300)) 
